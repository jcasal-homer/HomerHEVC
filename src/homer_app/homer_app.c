...
//	strcpy(file_ref_name, FILE_REF);
	...
	HmrCfg.performance_mode = PERF_FAST_COMPUTATION;//PERF_FAST_COMPUTATION;//0=PERF_FULL_COMPUTATION (HM), 1=PERF_FAST_COMPUTATION (rd=1 or rd=2), 2=PERF_UFAST_COMPUTATION (rd=2)
