...
//#define FILE_IN  "C:\\Patrones\\DebugPattern_248x184.yuv"//DebugPattern_208x144.yuv"//DebugPattern_248x184.yuv"//
...
#define HOR_SIZE	192//1280//624//192//(208)//(384+16)//1280//1920//1280//(2*192)//1280//720//(2*192)//(192+16)//720//320//720
#define VER_SIZE	128//720//352//128//(144)//(256+16)//720//1080//720//(2*128)//720//576//(2*128)//(128+16)//320//576
#define FPS			25//25//50
...
void get_debug_config(HVENC_Cfg *cfg)
{
	...
	cfg->gop_size = 1;//1;
	cfg->num_b = 1;
	cfg->max_pred_partition_depth = 2;
